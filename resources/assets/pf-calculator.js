/*
 * Progressive enhancement for PF Calculator.
 *
...
(function () {
    ...
    var TOOL = 'pf-calculator';
    var CALCULATOR = 'pf';
    var FIELDS = [
        { name: 'basic_salary', argument: 'basicSalary', type: 'money' },
        { name: 'employer_restricts_to_ceiling', argument: 'employerRestrictsToCeiling', type: 'bool' },
        { name: 'eps_eligible', argument: 'epsEligible', type: 'bool' },
        { name: 'age', argument: 'age', type: 'int' },
        { name: 'reduced_rate', argument: 'reducedRate', type: 'bool' },
        { name: 'include_admin_charges', argument: 'includeAdminCharges', type: 'bool' },
